...
Public Class RptPedidosxVendedor
    ...
    Private Sub RptVentasxVendedor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If dpi = "" Then
            Me.PedidosTableAdapter.FillByTodoslosVendedores(Me.DB.Pedidos, fecha_inico, fecha_fin)
        Else
            Me.PedidosTableAdapter.FillByPedidosxVendedor(Me.DB.Pedidos, dpi, fecha_inico, fecha_fin)
        End If
